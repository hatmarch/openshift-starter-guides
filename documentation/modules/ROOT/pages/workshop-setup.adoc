...
+
--
You can access your OpenShift cluster from the link:https://developer.ibm.com/openlabs/guide/openshift/course/bring-your-own-app-lab/01.01[IBM Open Labs Dashboard,window=_blank]
...
. Locate the integrated cloud terminal from the link:https://developer.ibm.com/openlabs/guide/openshift/course/bring-your-own-app-lab/01.01[IBM Open Labs Dashboard,window=_blank]
+
