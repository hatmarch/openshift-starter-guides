...
include::partial$pipelines_operator_install.adoc[]

[#create_your_pipeline]
== Create Your Pipeline

NOTE: Ensure you met all xref:prerequisites.adoc[Prerequisites] before proceeding. For instance, a xref:prerequisites.adoc#github_account[GitHub account] is required for this section
