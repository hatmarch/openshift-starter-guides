= Nationalparks .NET App
:navtitle: Nationalparks .NET App

In this lab, we're going to deploy a backend service, developed in .NET
...
link:https://github.com/openshift-roadshow/nationalparks-dotnet.git[NationalParks GitHub Repository]
...
Select *.NET Core* as your Builder Image.
...
image::nationalparks-dotnet-new-dotnet-build.png[Nationalparks build]
